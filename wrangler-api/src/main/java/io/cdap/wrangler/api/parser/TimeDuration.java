...
/**
 * The TimeDuration class represents a time duration value with units (ms, s, m, h, etc.).
 * It implements the Token interface and provides methods to parse and convert between different time units.
 */
@PublicEvolving
