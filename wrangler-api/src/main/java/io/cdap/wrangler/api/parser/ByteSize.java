...
/**
 * The ByteSize class represents a byte size value with units (B, KB, MB, GB, etc.).
 * It implements the Token interface and provides methods to parse and convert between different byte units.
 */
@PublicEvolving
